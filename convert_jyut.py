...
def build_replace_table():
    replace_data = [
        ...
        ['ng', 'ŋ', 'sm'], ['nj', 'ȵ', 'sm'], ['sl', 'ɬ', 'sm'], ['c', 'ʦʰ', 'sm'],
        ['z', 'ʦ', 'sm'], ['th', 'θ', 'sm'], ['d', 't', 'sm'], ['t', 'tʰ', 'sm'],
        ['g', 'k', 'sm'], ['k', 'kʰ', 'sm'], ['b', 'p', 'sm'], ['p', 'pʰ', 'sm'], ['s', 's', 'sm'],
        ['1', '45', 'jd'], ['2', '212', 'jd'], ['3', '33', 'jd'], ['4', '31', 'jd'],
        ['5', '212', 'jd'], ['6', '453', 'jd'], ['7', '45', 'jd'], ['8', '21', 'jd'], ['9', '453', 'jd'],
...
if __name__ == "__main__":
    path = "C:\\Users\\joengzaang\\PycharmProjects\\process_characters\\jyut2ipa.xlsx"
    replace_df = build_replace_table()
    processed_df = process_yutping_file(path, replace_df, True)
